...
export const domData = [
    {
        id: "main-logo",
        classList:
            "absolute left-1/2 top-1/2 px-10 py-8 bg-gradient-to-r from-rose-400 to-red-200 rounded-3xl transition-all duration-300 flex items-center justify-center",
        styles: {
            SIZE: ["60px", "100px", "120px", "140px", "180px", "220px"],
            TRANSLATE_X: "-50%",
    ...
    {
        id: "main-logo-text",
        classList: "absolute left-1/2 top-1/2 transition-all duration-300",
        styles: {
            SIZE: ["60px", "100px", "140px", "180px", "200px", "160px"],
    ...
    {
        id: "element-1",
        classList: "absolute left-52 top-24 rounded-xl bg-orange-300 transition-all duration-100",
        styles: {
            SIZE: "100px",
    ...
    {
        id: "element-2",
        classList: "absolute left-1/3 top-16 rounded-lg bg-orange-300 transition-all duration-100",
        styles: {
            SIZE: "80px",
    ...
    {
        id: "element-3",
        classList: "absolute right-52 top-32 rounded-lg bg-orange-300 transition-all duration-100",
        styles: {
            SIZE: "90px",
            TRANSLATE_X: ["10px", "20px", "30px", "40px", "50px", "60px", "80px"],
    ...
    {
        id: "element-4",
        classList: "absolute right-1/3 top-40 rounded-lg bg-orange-300 transition-all duration-100",
        styles: {
            SIZE: "60px",
    ...
    {
        id: "element-5",
        classList: "absolute left-72 top-96 rounded-lg bg-orange-300 transition-all duration-100",
        styles: {
            SIZE: ["60px", "70px", "80px", "90px", "100px", "110px", "120px", "130px"],
    ...
    {
        id: "element-6",
        classList: "absolute left-1/3 top-72 rounded-lg bg-orange-300 transition-all duration-100",
        styles: {
            SIZE: ["30px", "30px", "30px", "40px", "50px", "60px"],
